...
import { StyleSheet, Text, Picker, View, TouchableOpacity, Dimensions, Image, ScrollView, Modal, TextInput, FlatList } from 'react-native';
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={{alignItems: "center", justifyContent: "center", marginHorizontal:10, flexDirection: "row"}}>
                ...
                <View style={{width: screenWidth * 0.55, height: screenWidth * 0.2, backgroundColor: "#b2dfdb", borderBottomRightRadius: 3, borderTopRightRadius: 3, overflow: "hidden"}}>
