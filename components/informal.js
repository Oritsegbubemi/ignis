    ...
    <View style={styles.container}>
        ...
        <View style={{alignItems: "center", justifyContent: "center", marginHorizontal:10, flexDirection: "row"}}>
            ...
            <View style={{width: screenWidth * 0.5, height: screenWidth * 0.2, backgroundColor: "#b2dfdb", borderBottomRightRadius: 3, borderTopRightRadius: 3, overflow: "hidden"}}>
                ...
                <Text style={{color: "#00695c", fontSize: 7, alignSelf: "flex-start", marginLeft: 7, flexWrap: "wrap"}}>A marriage ceremony, especially considered as including the associated celebrations.</Text>
            </View>
        </View>
        </TouchableOpacity>
        ...
        <View style={{alignItems: "center", justifyContent: "center", marginHorizontal:10, flexDirection: "row"}}>
            ...
            <View style={{width: screenWidth * 0.5, height: screenWidth * 0.2, backgroundColor: "#b2dfdb", borderBottomRightRadius: 3, borderTopRightRadius: 3}}>
                ...
                <Text style={{color: "#00695c", fontSize: 7, alignSelf: "flex-start", marginLeft: 7, flexWrap: "wrap"}}>A social gathering of invited guests, typically involving eating, drinking, and entertainment.</Text>
            </View>
        </View>
        </TouchableOpacity>
        ...
        <View style={{alignItems: "center", justifyContent: "center", marginHorizontal:10, flexDirection: "row"}}>
            ...
            <View style={{width: screenWidth * 0.5, height: screenWidth * 0.2, backgroundColor: "#b2dfdb", borderBottomRightRadius: 3, borderTopRightRadius: 3}}>
                ...
                <Text style={{color: "#00695c", fontSize: 7, alignSelf: "flex-start", marginLeft: 7, flexWrap: "wrap"}}>An instance of two or more people coming together again after a period of separation.</Text>
            </View>
        </View>
        </TouchableOpacity>
        ...
        <View style={{alignItems: "center", justifyContent: "center", marginHorizontal:10, flexDirection: "row"}}>
            ...
            <View style={{width: screenWidth * 0.5, height: screenWidth * 0.2, backgroundColor: "#b2dfdb", borderBottomRightRadius: 3, borderTopRightRadius: 3}}>
                ...
                <Text style={{color: "#00695c", fontSize: 7, alignSelf: "flex-start", marginLeft: 7, flexWrap: "wrap"}}>A party held for a woman who is expecting a baby, to which friends and relatives (typically female) bring gifts for the child.</Text>
            </View>
        </View>
        </TouchableOpacity>
        ...
        <View style={{alignItems: "center", justifyContent: "center", marginHorizontal:10, flexDirection: "row"}}>
            ...
            <View style={{width: screenWidth * 0.5, height: screenWidth * 0.2, backgroundColor: "#b2dfdb", borderBottomRightRadius: 3, borderTopRightRadius: 3}}>
                ...
                <Text style={{color: "#00695c", fontSize: 7, alignSelf: "flex-start", marginLeft: 7, flexWrap: "wrap"}}>A meal taken outdoors (al fresco) as part of an excursion.</Text>
            </View>
        </View>
        </TouchableOpacity>
        </ScrollView>
